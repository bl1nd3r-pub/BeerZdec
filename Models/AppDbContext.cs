...
public partial class AppDbContext : DbContext
{
    ...
    // === Новые таблицы для прав доступа ===
    public virtual DbSet<AppView> AppViews { get; set; }
    public virtual DbSet<RoleViewAccess> RoleViewAccesses { get; set; }

    // === Остальные DbSets (без изменений) ===
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("AppViews"); // 👈 Явно указываем имя таблицы
            entity.HasKey(e => e.ViewId).HasName("PK_AppViews");
            entity.Property(e => e.ViewCode).HasMaxLength(50).IsRequired();
            entity.Property(e => e.ViewName).HasMaxLength(100).IsRequired();
            entity.HasIndex(e => e.ViewCode).IsUnique();
        });

        // === RoleViewAccess (ИСПРАВЛЕНО) ===
        modelBuilder.Entity<RoleViewAccess>(entity =>
        {
            entity.ToTable("RoleViewAccess"); // 👈 Явно указываем имя таблицы
            entity.HasKey(e => new { e.UserRoleId, e.ViewId }).HasName("PK_RoleViewAccess");

            entity.HasOne(e => e.Role)
                  .WithMany(r => r.RoleViewAccesses)
                  .HasForeignKey(e => e.UserRoleId)
                  .HasConstraintName("FK_RoleViewAccess_UserRoles");

            entity.HasOne(e => e.View)
                  .WithMany(v => v.RoleViewAccesses)
                  .HasForeignKey(e => e.ViewId)
                  .HasConstraintName("FK_RoleViewAccess_AppViews");
        });

        // === Остальные конфигурации (без изменений, кроме порядка) ===
        ...
        modelBuilder.Entity<BeerOrder>(entity =>
        {
            ...
            entity.HasOne(d => d.BeerOrder_EmployeeNavigation).WithMany(p => p.BeerOrders)
                .HasForeignKey(d => d.BeerOrder_Employee).HasConstraintName("FK_BeerOrder_Employee");
            entity.HasOne(d => d.BeerOrder_SellerNavigation).WithMany(p => p.BeerOrders)
                .HasForeignKey(d => d.BeerOrder_Seller).HasConstraintName("FK_BeerOrder_Seller");
        });
        ...
        modelBuilder.Entity<BeerOrderItem>(entity =>
        {
            ...
            entity.HasOne(d => d.BeerOrderItem_OrderNavigation).WithMany(p => p.BeerOrderItems)
                .HasForeignKey(d => d.BeerOrderItem_Order).HasConstraintName("FK_BeerOrderItem_Order");
            entity.HasOne(d => d.BeerOrderItem_PackBatchNavigation).WithMany(p => p.BeerOrderItems)
                .HasForeignKey(d => d.BeerOrderItem_PackBatch).HasConstraintName("FK_BeerOrderItem_PackBatch");
        });

        modelBuilder.Entity<BeerStyle>(entity =>
        {
            entity.HasKey(e => e.BeerStyle_ID).HasName("PK_BeerStyle_ID");
            entity.Property(e => e.BeerStyle_Description).HasMaxLength(200).HasDefaultValue("(Этот стиль не имеет описания)");
        ...
        modelBuilder.Entity<BrewEquipment>(entity =>
        {
            ...
            entity.HasOne(d => d.BrewEquipment_TypeNavigation).WithMany(p => p.BrewEquipments)
                .HasForeignKey(d => d.BrewEquipment_Type).HasConstraintName("FK_BrewEquipment_Type");
        });
        ...
        modelBuilder.Entity<BrewingBatch>(entity =>
        {
            ...
            entity.HasOne(d => d.BrewBatch_BeerStyleNavigation).WithMany(p => p.BrewingBatches)
                .HasForeignKey(d => d.BrewBatch_BeerStyle).HasConstraintName("FK_BrewBatch_BeerStyle");
            entity.HasOne(d => d.BrewBatch_ConditionalTankNavigation).WithMany(p => p.BrewingBatchBrewBatch_ConditionalTankNavigations)
                .HasForeignKey(d => d.BrewBatch_ConditionalTank).HasConstraintName("FK_BrewBatch_ConditionalTank");
            entity.HasOne(d => d.BrewBatch_FermenterNavigation).WithMany(p => p.BrewingBatchBrewBatch_FermenterNavigations)
                .HasForeignKey(d => d.BrewBatch_Fermenter).HasConstraintName("FK_BrewBatch_Fermenter");
            entity.HasOne(d => d.BrewBatch_TechnologistNavigation).WithMany(p => p.BrewingBatches)
                .HasForeignKey(d => d.BrewBatch_Technologist).HasConstraintName("FK_BrewBatch_Technologist");
        });
        ...
        modelBuilder.Entity<Crude>(entity =>
        {
            ...
            entity.HasOne(d => d.Crude_MaltBatchNavigation).WithMany(p => p.Crudes)
                .HasForeignKey(d => d.Crude_MaltBatch).HasConstraintName("FK_Crude_MaltBatch");
            entity.HasOne(d => d.Crude_OtherBatchNavigation).WithMany(p => p.Crudes)
                .HasForeignKey(d => d.Crude_OtherBatch).HasConstraintName("FK_Crude_OtherBatch");
        });
        ...
        modelBuilder.Entity<CrudeSupply>(entity =>
        {
            ...
            entity.HasOne(d => d.CrudeSupply_CrudeNavigation).WithMany(p => p.CrudeSupplies)
                .HasForeignKey(d => d.CrudeSupply_Crude).HasConstraintName("FK_CrudeSupply_Crude");
            entity.HasOne(d => d.CrudeSupply_SupplierNavigation).WithMany(p => p.CrudeSupplies)
                .HasForeignKey(d => d.CrudeSupply_Supplier).HasConstraintName("FK_CrudeSupply_Supplier");
        });
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasOne(d => d.Emp_PositionNavigation).WithMany(p => p.Employees)
                .HasForeignKey(d => d.Emp_Position).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<GrainBatch>(entity =>
        {
            ...
            entity.HasOne(d => d.GB_HarvestNavigation).WithMany(p => p.GrainBatches)
                .HasForeignKey(d => d.GB_Harvest).OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_GB_Harvest");
            entity.HasOne(d => d.GB_QualGradeNavigation).WithMany(p => p.GrainBatches)
                .HasForeignKey(d => d.GB_QualGrade).OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_GB_QualGrade");
            entity.HasOne(d => d.GB_StatusNavigation).WithMany(p => p.GrainBatches)
                .HasForeignKey(d => d.GB_Status).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<HarvestEvent>(entity =>
        {
            ...
            entity.HasOne(d => d.HarvestEvent_SowPlotNavigation).WithMany(p => p.HarvestEvents)
                .HasForeignKey(d => d.HarvestEvent_SowPlot).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<ISType>(entity =>
        {
            ...
            entity.HasOne(d => d.ISType_CategoryNavigation).WithMany(p => p.ISTypes)
                .HasForeignKey(d => d.ISType_Category).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<ISTypeCategory>(entity =>
        {
            ...
            entity.Property(e => e.ISTC_Descr).HasMaxLength(200).HasDefaultValue("У этого типа нет описания");
        ...
        modelBuilder.Entity<MaltBatch>(entity =>
        {
            ...
            entity.HasOne(d => d.MaltBatch_MaltProcessNavigation).WithMany(p => p.MaltBatches)
                .HasForeignKey(d => d.MaltBatch_MaltProcess).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<MaltEquipType>(entity =>
        {
            ...
            entity.Property(e => e.MaltEquipType_Description).HasMaxLength(200).HasDefaultValue("У этого типа нет описания");
        ...
        modelBuilder.Entity<MaltEquipment>(entity =>
        {
            ...
            entity.HasOne(d => d.MaltEquipment_MaltingLineNavigation).WithMany(p => p.MaltEquipments)
                .HasForeignKey(d => d.MaltEquipment_MaltingLine).OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_MaltEquipment_MaltingLine");
            entity.HasOne(d => d.MaltEquipment_TypeNavigation).WithMany(p => p.MaltEquipments)
                .HasForeignKey(d => d.MaltEquipment_Type).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<MaltProcess>(entity =>
        {
            ...
            entity.HasOne(d => d.MaltProcess_MaltLineNavigation).WithMany(p => p.MaltProcesses)
                .HasForeignKey(d => d.MaltProcess_MaltLine).OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_MaltProcess_MaltLine");
            entity.HasOne(d => d.MaltProcess_MaltOrderNavigation).WithMany(p => p.MaltProcesses)
                .HasForeignKey(d => d.MaltProcess_MaltOrder).OnDelete(DeleteBehavior.ClientSetNull)
            ...
            entity.HasOne(d => d.MaltProcess_TechnologistNavigation).WithMany(p => p.MaltProcesses)
                .HasForeignKey(d => d.MaltProcess_Technologist).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<PackagingBatch>(entity =>
        {
            ...
            entity.HasOne(d => d.PackBatch_BrewBatchNavigation).WithMany(p => p.PackagingBatches)
                .HasForeignKey(d => d.PackBatch_BrewBatch).HasConstraintName("FK_PackBatch_BrewBatch");
        });
        ...
        modelBuilder.Entity<RetailStore>(entity =>
        {
            ...
            entity.HasOne(d => d.RetailStore_ManagerNavigation).WithMany(p => p.RetailStores)
                .HasForeignKey(d => d.RetailStore_Manager).HasConstraintName("FK_RetailStore_Manager");
        });
        ...
        modelBuilder.Entity<SoilType>(entity =>
        {
            ...
            entity.HasOne(d => d.SoilType_TextureClassNavigation).WithMany(p => p.SoilTypes)
                .HasForeignKey(d => d.SoilType_TextureClass).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<SowingPlot>(entity =>
        {
            ...
            entity.HasOne(d => d.SowPlot_IrrigationSystemTypeNavigation).WithMany(p => p.SowingPlots)
                .HasForeignKey(d => d.SowPlot_IrrigationSystemType).OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SowPlot_IrrigationSystemType");
            entity.HasOne(d => d.SowPlot_SoilTypeNavigation).WithMany(p => p.SowingPlots)
                .HasForeignKey(d => d.SowPlot_SoilType).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<StorageMove>(entity =>
        {
            ...
            entity.HasOne(d => d.StorageMoves_FromStorageNavigation).WithMany(p => p.StorageMoveStorageMoves_FromStorageNavigations)
                .HasForeignKey(d => d.StorageMoves_FromStorage).HasConstraintName("FK_StorageMoves_FromStorage");
            entity.HasOne(d => d.StorageMoves_GrainBatchNavigation).WithMany(p => p.StorageMoves)
                .HasForeignKey(d => d.StorageMoves_GrainBatch).HasConstraintName("FK_StorageMoves_GrainBatch");
            entity.HasOne(d => d.StorageMoves_MovedByNavigation).WithMany(p => p.StorageMoves)
                .HasForeignKey(d => d.StorageMoves_MovedBy).HasConstraintName("FK_StorageMoves_MovedBy");
            entity.HasOne(d => d.StorageMoves_ToStorageNavigation).WithMany(p => p.StorageMoveStorageMoves_ToStorageNavigations)
                .HasForeignKey(d => d.StorageMoves_ToStorage).HasConstraintName("FK_StorageMoves_ToStorage");
        });
        ...
        modelBuilder.Entity<StorageToMalting>(entity =>
        {
            ...
            entity.HasOne(d => d.STM_MaltOrderNavigation).WithMany(p => p.StorageToMaltings)
                .HasForeignKey(d => d.STM_MaltOrder).OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_STM_MaltOrder");
            entity.HasOne(d => d.STM_StorageNavigation).WithMany(p => p.StorageToMaltings)
                .HasForeignKey(d => d.STM_Storage).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasOne(e => e.RoleNavigation).WithMany(r => r.Users)
                .HasForeignKey(e => e.UserRoleId).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Variety>(entity =>
        {
            ...
            entity.HasOne(d => d.Variety_GrainNavigation).WithMany(p => p.Varieties)
                .HasForeignKey(d => d.Variety_Grain).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<WareCell>(entity =>
        {
            ...
            entity.HasOne(d => d.WareCell_CrudeNavigation).WithMany(p => p.WareCells)
                .HasForeignKey(d => d.WareCell_Crude).HasConstraintName("FK_WareCell_Crude");
        });
