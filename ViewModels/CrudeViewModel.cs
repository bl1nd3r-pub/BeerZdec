...
namespace BeerZdec.ViewModels
{
    public class CrudeViewModel : ObservableObject
    {
        ...
        private readonly CrudeStockViewModel _crudeStockViewModel;
        ...
        public CrudeViewModel(
            ...
            CrudeStockViewModel crudeStockViewModel
            ...
            )
        {
            ...
            _crudeStockViewModel = crudeStockViewModel ?? throw new ArgumentNullException(nameof(crudeStockViewModel));
        ...
        public CrudeStockViewModel CrudeStockContext => _crudeStockViewModel;
        ...
        public void Initialize()
        {
            ...
            _crudeStockViewModel.LoadCommand.Execute(null);
